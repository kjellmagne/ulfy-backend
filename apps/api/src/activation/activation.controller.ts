    ...
    schema: {
      example: {
        ...
        config: {
          ...
          managedPolicy: { allowPolicyOverride: false, hideSettings: true, userMayChangeSpeechProvider: true, userMayChangeFormatter: true, userMayChangePrivacyReviewProvider: true },

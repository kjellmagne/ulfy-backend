...
const enterpriseConfigExample = {
  ...
  templateRepositoryUrl: "https://kvasetech.com/skrivdet/api/v1/templates/manifest",
...
const mobileConfigSchema = {
  ...
  properties: {
    ...
    templateRepositoryUrl: { type: "string", nullable: true, example: "https://kvasetech.com/skrivdet/api/v1/templates/manifest", description: "Enterprise template catalog URL. App should authenticate repository calls with Authorization: Bearer <activationToken>." },

...
const managedPolicySchema = {
  ...
  description: [
    ...
    "allowPolicyOverride is the master bypass. Granular flags allow only one area to change.",
    "Client logic should treat canChangeFormatter as allowPolicyOverride || userMayChangeFormatter, and canChangePrivacyReview as allowPolicyOverride || userMayChangePrivacyReviewProvider.",
...
const mobileConfigSchema = {
  ...
  properties: {
    ...
    privacyReviewProviderType: { type: "string", enum: ["local_heuristic", "openai_compatible", "ollama"], nullable: true, description: "Privacy review/guardrail provider. OpenAI and vLLM should be represented as openai_compatible plus endpoint/model/API key." },

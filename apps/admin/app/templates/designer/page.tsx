...
const designerHelp = {
  templateIntention: "Describe the note you want and the situation it should handle. The helper turns this into a draft you can edit. Example: A Norwegian follow-up note after a municipal health meeting, with summary, decisions, next steps, owners, and deadlines.",
  title: "This is the name people see when choosing a template. Use the words they would look for in the moment. Example: Follow-up meeting, Home visit note, Employee check-in, or Incident summary.",
  shortDescription: "A short promise of the result. It should help someone decide if this is the right template. Example: Creates a concise follow-up note with decisions, open questions, and next actions.",
  language: "The main language for the finished note. It nudges headings, dates, and phrasing toward that language. Example: Use nb-NO for a note that should read naturally in Norwegian.",
  category: "Where this template lives in the catalog. Pick the place users would naturally look first. Example: Put Employee check-in under HR, and Home visit note under Health or Field work.",
  icon: "The symbol shown with the template in the app. Choose something that gives a quick visual clue. Example: A microphone for dictation, a document for formal notes, or people for meetings.",
  version: "A simple label for the template text itself. Most edits can leave this alone; publishing decides the version users receive. Example: 0.2.0 for a draft that has changed shape before its first real rollout.",
  tags: "Extra labels for search and grouping. Use them for themes, departments, or situations. Example: HR, follow-up, municipality, confidential, inspection, or leadership.",
  contextPurpose: "The main job of the template. This is the north star for the generated note, so be specific about the useful outcome. Example: Turn a care conversation into a short follow-up note with needs, decisions, responsibilities, and next contact.",
  typicalSetting: "Where and how this template is normally used. This gives the note better common sense about what details matter. Example: A phone call with a resident, a weekly team meeting, a field inspection, or a manager check-in.",
  typicalParticipants: "Who normally takes part. Roles are usually more useful than names because they help the note understand responsibility. Example: Case worker, resident, next of kin, department manager, employee, or external supplier.",
  goals: "What the finished note should help the reader do next. Add one goal per line. Example: Understand what happened, see what was decided, know who owns each next step, and spot unresolved questions.",
  relatedProcesses: "The workflow this note belongs to. This helps the note support the real process around it. Example: Case follow-up, archive documentation, employee development, quality deviation, or customer onboarding.",
  voice: "Who the note sounds like it is written by. This changes wording such as I observed, we agreed, or the team decided. Example: Use first person singular for a personal field note, and third person for an archive-ready summary.",
  audience: "Who is likely to read the note. A private note can be lighter; a note for HR, archive, or leadership should be clearer and more complete. Example: Choose self for personal notes, colleagues for handovers, and archive for formal records.",
  tone: "How formal the writing should feel. Match the place the note will be read. Example: Conversational for coaching notes, semi-formal for normal follow-up, and formal for archive or HR documentation.",
  preserveOriginalVoice: "Keep the speaker's own wording when the exact phrasing matters. This is useful for reflections, quotes, or sensitive statements. Example: Keep I felt unsafe if that was said directly, instead of smoothing it into a neutral summary.",
  styleRules: "Small writing habits this template should follow. Keep each rule practical and visible in the result. Example: Use plain language, avoid judgmental wording, keep bullets short, write in Norwegian, or never invent deadlines.",
  sectionTitle: "The heading shown in the finished note. Make it clear enough that the reader knows what belongs there. Example: Decisions, Next steps, Open questions, Risks, Observations, or Follow-up.",
  sectionFormat: "The shape of this section: paragraph, bullets, table, fill-in fields, or quotes. Pick the shape that makes the content easiest to scan. Example: Use a table for action items, bullets for decisions, and prose for a short narrative summary.",
  sectionRequired: "Required sections always appear, even when little was said. Use this for sections readers expect every time. Example: Summary may be required; Risks may be optional if no risks were discussed.",
  sectionPurpose: "What this section is meant to capture. This is often the most important instruction for getting the right content in the right place. Example: List only decisions that were clearly agreed, not ideas that were merely discussed.",
  extractionHints: "Words or signals the note should listen for when filling this section. Add phrases people actually say. Example: For action items, use follow up, responsible, deadline, send, call back, check, or by Friday.",
  requiredElements: "Things the note should include when the transcript supports them. One clear item per line is easiest to maintain. Example: Include date, participants, decision, owner, deadline, and unresolved questions when mentioned.",
  exclusions: "Things to leave out even if they appear in the transcript. Use this to protect privacy and keep the note focused. Example: Do not include small talk, unrelated medical details, private phone numbers, or speculation about motives.",
  uncertaintyHandling: "What to do when the recording is unclear or details are missing. Good templates mark uncertainty instead of guessing. Example: Write Not specified or Unclear from the recording rather than inventing a deadline or owner.",
  actionItemFormat: "How tasks should be written when they appear. A predictable pattern makes follow-up easier. Example: Task - Owner - Deadline, such as Send updated plan - Maria - Friday.",
  decisionMarker: "How clear decisions should be called out. This helps readers spot what was actually decided. Example: Prefix each item with Decision: or place decisions under a Decisions heading.",
  speakerAttribution: "Whether the note should say who said something. Use it when responsibility or source matters. Example: Role only is often enough, such as Case worker said..., while anonymized can protect privacy.",
  systemPromptAdditions: "Extra whole-template guidance that does not fit elsewhere. Use this sparingly so the template stays easy to understand. Example: Prioritize concrete follow-up needs over a long chronological summary.",
  fallbackBehavior: "What the note should do when a section cannot be filled. This prevents confident-looking guesses. Example: If no decisions were made, write No clear decisions were made in this conversation.",
  extractActionItems: "Also save clear tasks in the app's action list, not only in the document. Leave this on when follow-up work is part of the result. Example: Call resident on Monday becomes an action item when the transcript clearly says it.",
  structuredOutput: "An advanced field for teams that need predictable data behind the note. Most templates can leave this empty. Example: Use it only if another system needs fields like owner, deadline, priority, or case number.",
  sampleTranscript: "A realistic example used to test the template. The preview is only useful if this sample feels like a real recording. Example: Paste a messy conversation with interruptions, decisions, unclear parts, and a couple of follow-up tasks.",
  yaml: "The full template text behind the designer. Use it when you want to inspect or fine-tune exactly what will be saved. Example: If a field is not exposed yet in the form, you can still review it here before publishing."
} as const;

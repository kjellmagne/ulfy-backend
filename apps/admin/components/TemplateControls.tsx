...
const sfToLucideIcon: Record<string, LucideIcon> = {
  ...
  "quote.bubble": MessageSquareQuote,
  ...
  "clock.badge.checkmark": CircleCheck,
  "person": User,
  "person.fill": User,
  "person.text.rectangle": IdCard,
  "person.badge.clock": ContactRound,
  "person.badge.key": UserCheck,
  "person.badge.shield.checkmark": UserCheck,
  "person.crop.circle.badge.checkmark": UserCheck,
  "person.crop.rectangle.stack": ContactRound,
  "person.2": Users,
  "person.2.fill": Users,
  "person.2.wave.2": UsersRound,
  "person.2.wave.2.fill": UsersRound,
  "person.3": Users,
  "person.3.fill": Users,
  ...
  "rectangle.3.group.bubble": MessagesSquare,
  "phone": Phone,
  "video": Video,
  "video.fill": Video,
  "calendar": Calendar,
  ...
  "ear": Ear,
  "ear.and.waveform": Ear,
  "display": Monitor,
  "display.and.arrow.down": Download,
  ...
  "iphone.gen3.radiowaves.left.and.right": Smartphone,
  "lightbulb.fill": Lightbulb,
  "macbook": Laptop,
  "megaphone.fill": Megaphone,
  "network": Network,
  "questionmark.bubble.fill": MessageCircleQuestion,
  "radio.fill": Radio,
  "rectangle.and.pencil.and.ellipsis": FilePenLine,
  "rectangle.inset.filled.and.person.filled": ContactRound,
  "server.rack": Server,
...
export function TemplateIcon({ symbol, size = 18 }: { symbol?: string | null; size?: number }) {
  const appIcon = appIconAssets[symbol || ""];
  if (appIcon) {
    const style: CSSProperties = { width: size, height: size };
    return <img className="app-provider-icon" src={appIcon.src} alt="" title={appIcon.label} aria-hidden="true" style={style} />;
  }

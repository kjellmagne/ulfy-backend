...
export const ManagedPolicyPayload = z.object({
  ...
  managePrivacyControl: z.boolean().default(false),
  privacyControlManaged: z.boolean().optional(),
  userMayChangePrivacyControl: z.boolean().default(false),
  allowPrivacyControlChange: z.boolean().optional(),
  managePIIControl: z.boolean().default(false),
  piiControlManaged: z.boolean().optional(),
  userMayChangePIIControl: z.boolean().default(false),
  allowPIIControlChange: z.boolean().optional(),
  managePrivacyReviewProvider: z.boolean().default(false),
  privacyReviewProviderManaged: z.boolean().optional(),
  managePrivacyReview: z.boolean().optional(),
